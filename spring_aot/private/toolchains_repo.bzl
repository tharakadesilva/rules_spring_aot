...
# By default all these toolchains are registered by the spring_aot_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:spring_aot_toolchain",
    toolchain_type = "@rules_spring_aot//spring_aot:toolchain_type",
)
""".format(
            platform = platform,
