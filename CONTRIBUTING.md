...
some other ruleset that depends on rules_spring_aot, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_spring_aot=$(pwd)"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_spring_aot` on your system will point to this folder.
...
https://github.com/tharakadesilva/rules_spring_aot/actions/workflows/tag.yaml
